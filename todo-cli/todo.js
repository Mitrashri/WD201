const todoList = () => {
    ...
    const dueToday = () => {
      ...
      let DueTodayTodo = [];
      DueTodayTodo=all.filter((TodoList) => TodoList.dueDate === new Date().toISOString().slice(0,10));
      return DueTodayTodo;
    }
    ...
    const dueLater = () => {
      ...
      let DueLaterTodo = [];
      DueLaterTodo = all.filter((TodoList) => TodoList.dueDate > new Date().toISOString().slice(0,10));
      return DueLaterTodo;
      ;
    }
